                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            <div class="card" style="border-radius: 1rem; background-color:#212529">
                                <div class="card-body p-5">
                                    <h3 class="fw-bold mb-2 text-uppercase mb-5">Nuevo libro</h3>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="isbn" class="form-control" name="isbn" min="13" maxlength="13" required />
