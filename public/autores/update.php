...
if(isset($_POST["guardar"])){
    ...
    $_SESSION["mensaje"]="Autor actualizado";
    header("Location:index.php");
                            ...
                            <div class="card" style="border-radius: 1rem; background-color:#212529">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="nombre" class="form-control" name="nombre" required value="<?php echo $autor->nombre ?>"/>
                                        <?php Tools::mostrarError("err_nombre") ?>
                                    </div>

                                    <div class="mb-4">
                                        <label class="form-label" for="apellidos">Apellidos</label>
                                        <input type="text" id="apellidos" class="form-control" name="apellidos" required value="<?php echo $autor->apellidos ?>"/>
