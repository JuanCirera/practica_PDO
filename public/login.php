                            ...
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        ...
                                        <input type="email" id="user" class="form-control form-control-lg" name="user" required />
                                    ...
                                    <button class="btn btn-outline-info btn-lg px-5 mb-3" name="login" type="submit"><i class="fa-solid fa-right-to-bracket"></i> Login</button><br>
                                    <button class="btn btn-outline-light btn-lg px-5" name="login" type="submit"> Register</button>
